<?php 
use QuotesApi\ApiRequest;
use QuotesApi\QuotesDatafile;
use QuotesApi\PredisCaching;
...
# preparing chaching, set false as no caching in use
$caching = false;
$caching = new PredisCaching($config);

# preparing data source
$data_source = new QuotesDatafile($config);

# processing API request on selected data source with specific configuration
$api_request = new ApiRequest($data_source, $config, $caching);
$api_request->process();
